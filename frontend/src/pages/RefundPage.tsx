    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <div className="px-4 lg:px-12 mt-6 mb-6">
        ...
        <p className="text-gray-500 text-sm leading-6">
          ...
          На ArtTicket мы стремимся обеспечить максимальное удобство
          для наших посетителей. Ознакомьтесь с правилами возврата билетов.
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-6">
                    ...
                    Возврат билета возможен не позднее чем
                    за 24 часа до даты и времени посещения.
                    Возврат производится в полном объеме
                    стоимости билета на тот же счет,
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-6">
                    ...
                    При возврате билета менее чем за 24 часа,
                    но не позднее 3 часов до начала сеанса,
                    возврат составляет 50% от стоимости билета.
                    Комиссия сервиса не возвращается.
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-6">
                    ...
                    Возврат билета менее чем за 3 часа до начала
                    сеанса или после начала мероприятия невозможен.
                    Исключения составляют случаи отмены мероприятия
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-6">
                    ...
                    Если музей или выставка отменяет мероприятие,
                    вам будет предложен полный возврат средств
                    или перенос билета на другую дату.
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-6">
                    ...
                    Если вы не смогли попасть на мероприятие
                    из-за технических проблем с нашей стороны
                    (например, QR-код не сработал),
