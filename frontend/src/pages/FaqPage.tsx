...
export default function FaqPage() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      {/* TITLE */}
      <div className="px-12 mt-6 mb-8">
        <h1 className="text-2xl font-semibold mb-1">
          Часто задаваемые вопросы
        </h1>
        <p className="text-gray-500 text-sm">
          Ответы на самые популярные вопросы о сервисе ArtTicket
        </p>
      </div>
        ...
        <div className="flex flex-col gap-6 w-full max-w-[700px]">
          ...
          {sections.map((section, si) => (
            ...
            >
              ...
              {/* TITLE */}
              <div className="text-center py-3 font-medium bg-[#F5F5F5]">
                {section.title}
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full flex justify-between items-center px-4 py-3 text-left text-sm bg-[#F5F5F5] hover:bg-[#ECECEC] transition"
                    >
                      {item.q}
                    ...
                    {openIndex === currentIndex && (
                      <div className="px-4 pb-4 text-sm text-gray-600 bg-[#F5F5F5]">
                        {item.a}
                      </div>
                    )}
      ...
      {/* FOOTER */}
      <div className="bg-black text-white px-12 py-10 mt-20">
