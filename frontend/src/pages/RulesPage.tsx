    ...
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <div className="px-4 lg:px-12 mt-6 mb-6">
        ...
        <p className="text-gray-500 text-sm leading-6 max-w-[700px]">
          ...
          Для комфортного посещения музеев и выставок,
          пожалуйста, ознакомьтесь с общими правилами.
          Обратите внимание, что в отдельных музеях
          могут действовать дополнительные требования.
      ...
      <div className="px-4 lg:px-12 flex justify-center">
        ...
        <div className="flex flex-col gap-6 w-full max-w-[800px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-sm text-gray-700">
              ...
              <div>
                ...
                <p className="leading-6">
                  ...
                  Фото разрешено без вспышки,
                  если иное не указано музеем.
              ...
              <div>
                ...
                <p className="leading-6">
                  ...
                  Верхнюю одежду, сумки и зонты
                  рекомендуется сдавать в гардероб.
              ...
              <div>
                ...
                <p className="leading-6">
                  ...
                  Группы должны сопровождаться гидом
                  и соблюдать установленный маршрут.
          ...
          <div className="bg-[#F5F5F5] rounded-2xl p-5 lg:p-6">
            ...
            <ul className="text-sm text-gray-700 list-disc pl-5 space-y-2 leading-6">

              <li>
                Фотографировать без вспышки
                (если разрешено музеем)
              </li>
              ...
              <li>
                Посещать выставки с детьми
              </li>

              <li>
                Приносить небольшие личные вещи
              </li>

              <li>
                Покупать билеты онлайн
                и предъявлять QR-код
              </li>
          ...
          <div className="bg-[#F5F5F5] rounded-2xl p-5 lg:p-6">
            ...
            <ul className="text-sm text-gray-700 list-disc pl-5 space-y-2 leading-6">
              ...
              <li>
                Трогать экспонаты,
                если это не предусмотрено экспозицией
              </li>
